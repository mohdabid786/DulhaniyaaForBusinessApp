...
public class VendorViews {
    ...
    @SerializedName("vuv_date")
    private String vuvDate;
    @SerializedName("vuv_no")
    private String vuvNo;
    @SerializedName("id")
    private String id;
    ...
    public void setVuvId(String vuvId) {
        this.vuvId = vuvId;
    }
    ...
    public String getVuvDate() {
        return vuvDate;
    }

    public void setVuvDate(String vuvDate) {
        this.vuvDate = vuvDate;
    }

    public String getVuvNo() {
        return vuvNo;
    }

    public void setVuvNo(String vuvNo) {
        this.vuvNo = vuvNo;
    }

...
public class GetAllStateAdapter extends BaseAdapter implements SpinnerAdapter {
    private final ArrayList<String> mCityList;
    private Context context;

    public GetAllStateAdapter(Context context, int simple_spinner_item, ArrayList<String> mCityList) {

...
public class WorkingDaysAdapter extends BaseAdapter implements SpinnerAdapter {
    private final ArrayList<String> mCityList;
    private Context context;

    public WorkingDaysAdapter(Context context, int simple_spinner_item, ArrayList<String> mCityList) {
